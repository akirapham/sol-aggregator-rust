    ...
    meteora_dlmm_sdk::dlmm::accounts::LbPair {
        ...
        reward_infos: [
            meteora_dlmm_sdk::dlmm::types::RewardInfo {
                ...
                cumulative_seconds_with_empty_liquidity_reward: pool.lbpair.reward_infos[0]
            ...
            meteora_dlmm_sdk::dlmm::types::RewardInfo {
                ...
                cumulative_seconds_with_empty_liquidity_reward: pool.lbpair.reward_infos[1]
                    .cumulative_seconds_with_empty_liquidity_reward,
            },
        ],
...
pub fn to_commons_bitmap_extension(
    _pool: &MeteoraDlmmPoolState,
...
pub fn get_commons_bin_arrays(
    pool: &MeteoraDlmmPoolState,
) -> HashMap<anchor_lang::prelude::Pubkey, meteora_dlmm_sdk::dlmm::accounts::BinArray> {
    let to_anchor_pubkey = |p: Pubkey| anchor_lang::prelude::Pubkey::from(p.to_bytes());
    let mut bin_arrays = HashMap::new();
    for (index, state) in &pool.bin_arrays {
        let address_anchor = to_anchor_pubkey(pool.address);
        let (pubkey, _) =
            meteora_dlmm_sdk::pda::derive_bin_array_pda(address_anchor, *index as i64);
